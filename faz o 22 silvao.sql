...
INSERT INTO itens_pedido VALUES (null,1,22,4,9.50,38.00);
...
INSERT INTO itens_pedido VALUES (null,10,6,1,2.30,2.30);
 ...
 select cliente.nome as nomeCliente,cidade.nome as nomeCidade,estado.nome as nomeEstado,pedido.data_pedido,vendedor.nome as nomeVendedor,itens_pedido.qtde,itens_pedido.valor_unit,itens_pedido.valor_total,produto.nome as nomeProduto,categoria.nome as Categoria,marca.nome as Marca from cidade
inner join cliente
...
inner join produto
on itens_pedido.idPedido = produto.idProduto
inner join marca
